...
RSpec.describe "socioeduk/tecnico_jovem_visita_familiares/new", type: :view do
  before(:each) do
    assign(:socioeduk_tecnico_jovem_visita_familiar, Socioeduk::TecnicoJovemVisitaFamiliar.new(
  ...
  xit "renders new socioeduk_tecnico_jovem_visita_familiar form" do
    render

    assert_select "form[action=?][method=?]", socioeduk_tecnico_jovem_visita_familiares_path, "post" do
