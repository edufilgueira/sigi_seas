...
RSpec.describe "socioeduk/pedagogico_jovem_escolaridade_medidas/edit", type: :view do
  before(:each) do
  ...
  xit "renders the edit socioeduk_pedagogico_jovem_escolaridade_medida form" do
    render

    assert_select "form[action=?][method=?]", socioeduk_pedagogico_jovem_escolaridade_medida_path(@socioeduk_pedagogico_jovem_escolaridade_medida), "post" do
