...
RSpec.describe "socioeduk/relatorio_diarios/edit", type: :view do
  before(:each) do
  ...
  it "renders the edit socioeduk_relatorio_diario form" do
    render

    assert_select "form[action=?][method=?]", socioeduk_relatorio_diario_path(@socioeduk_relatorio_diario), "post" do
