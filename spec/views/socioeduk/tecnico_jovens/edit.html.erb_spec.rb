...
RSpec.describe "socioeduk/tecnico_jovens/edit", type: :view do
  before(:each) do
  ...
  xit "renders the edit socioeduk_tecnico_jovem form" do
    render

    assert_select "form[action=?][method=?]", socioeduk_tecnico_jovem_path(@socioeduk_tecnico_jovem), "post" do
