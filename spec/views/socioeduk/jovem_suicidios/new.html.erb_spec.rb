...
RSpec.describe "socioeduk/jovem_suicidios/new", type: :view do
  before(:each) do
    assign(:socioeduk_jovem_suicidio, Socioeduk::JovemSuicidio.new(
      :jovem => nil,
  ...
  xit "renders new socioeduk_jovem_suicidio form" do
    render

    assert_select "form[action=?][method=?]", socioeduk_jovem_suicidios_path, "post" do
