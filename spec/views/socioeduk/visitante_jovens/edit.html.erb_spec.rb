...
RSpec.describe "socioeduk/visitante_jovens/edit", type: :view do
  before(:each) do
  ...
  xit "renders the edit socioeduk_visitante_jovem form" do
    render

    assert_select "form[action=?][method=?]", socioeduk_visitante_jovem_path(@socioeduk_visitante_jovem), "post" do
