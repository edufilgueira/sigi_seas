...
RSpec.describe "socioeduk/jovem_recepcoes/edit", type: :view do
  before(:each) do
  ...
  it "renders the edit socioeduk_jovem_recepcao form" do
    render

    assert_select "form[action=?][method=?]", socioeduk_jovem_recepcao_path(@socioeduk_jovem_recepcao), "post" do
