...
RSpec.describe "socioeduk/saude_jovens/edit", type: :view do
  before(:each) do
  ...
  xit "renders the edit socioeduk_saude_jovem form" do
    render

    assert_select "form[action=?][method=?]", socioeduk_saude_jovem_path(@socioeduk_saude_jovem), "post" do
